...
// ---- Common Options ----
var gMonths=["बैशाख","जेष्ठ","असार","साउन","भदौ","असोज","कार्तिक","मंसिर","पुष","माघ","फाल्गुन","चैत्र"];
var gWeekDay=["S","M","T","W","T","F","S"];	// weekday caption from Sunday to Saturday

var gBegin=[1990,1,1];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
//var gBegin=gToday;	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
var gEnd=[2080,12,31];	// calendar date range end at [Year,Month,Date]
